...
Studio meters in [credits][credits] drawn from a tenant pool. Verify allocation
and exhaustion policy in the Power Platform admin centre before publishing —
not after, when the failure mode is a degraded experience for everyone at once.
