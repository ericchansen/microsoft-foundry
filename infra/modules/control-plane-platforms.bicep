...
@description('Deploy the optional Azure SRE Agent coverage resources.')
param deploySreAgent bool = false

@description('Deploy the optional Logic Apps Approvals coverage resources.')
...
var validatedSreOperatorGroupObjectId = deploySreAgent && empty(trim(sreOperatorGroupObjectId))
  ? fail('sreOperatorGroupObjectId is required when deploySreAgent is true')
  : sreOperatorGroupObjectId

resource applicationInsights 'Microsoft.Insights/components@2020-02-02' existing = {
  name: applicationInsightsName
}

resource sreIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2024-11-30' = if (deploySreAgent) {
...
resource approvalsIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2024-11-30' = if (deployApprovalsWorkflow) {
...
resource sreAgent 'Microsoft.App/agents@2026-01-01' = if (deploySreAgent) {
...
resource approvalsWorkflow 'Microsoft.Logic/workflows@2019-05-01' = if (deployApprovalsWorkflow) {
...
resource approvalsDiagnostics 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = if (deployApprovalsWorkflow) {
...
resource sreUserReader 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (deploySreAgent) {
...
resource sreUserMonitoringReader 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (deploySreAgent) {
...
resource sreUserLogReader 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (deploySreAgent) {
...
resource sreSystemReader 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (deploySreAgent) {
...
resource sreSystemMonitoringReader 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (deploySreAgent) {
...
resource sreSystemLogReader 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (deploySreAgent) {
...
resource sreOperatorStandardUser 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (deploySreAgent) {
  name: guid(sreAgent!.id, validatedSreOperatorGroupObjectId, sreAgentStandardUserRoleId)
  scope: sreAgent
  properties: {
    principalId: validatedSreOperatorGroupObjectId
    principalType: 'Group'
...
output sreIdentityName string = deploySreAgent ? sreIdentity!.name : ''
output approvalsWorkflowName string = deployApprovalsWorkflow ? approvalsWorkflow!.name : ''
output approvalsIdentityName string = deployApprovalsWorkflow ? approvalsIdentity!.name : ''
